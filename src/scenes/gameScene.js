...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.btn_how_to = new Button(this, 1780 - 310, 78, "button_how_to");
    this.btn_how_to.setOrigin(0.5);
    this.btn_how_to.onClick.add(() => {
      this.game.customOptions.onHowTo()
    }, this)

    this.btn_undo = new Button(this, 1900 - 310 + 22, 78, "button_undo");
    this.btn_undo.onClick.add(() => this.controller.undo());
    this.btn_undo.setOrigin(0.5);

    this.score_img = this.add.image(923 - 310 + 110, 69, 'score')
    this.score_img.setOrigin(.5)

    this.time_img = this.add.image(1100 - 310 + 110, 69, 'time')
    this.time_img.setOrigin(.5)


    this.points_text = this.add.text(975 - 310 + 110, 69, "0", {
    ...
    this.time_text = this.add.text(1145 - 310 + 110, 69, "00:00", {
      fontFamily: "Titillium Web",
      fontStyle: 'bold',
      fontSize: "28px",
      color: "#000000",
